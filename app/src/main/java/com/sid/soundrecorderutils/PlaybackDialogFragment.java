...
public class PlaybackDialogFragment extends DialogFragment {
    ...
    private static final int WHAT=12321;
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case WHAT:
                        ...
                        mSeekBar.setProgress(bundle.getInt("mCurrentPosition"));
                        mCurrentProgressTextView.setText(String.format("%02d:%02d", bundle.getLong("minutes"), bundle.getLong("seconds")));
                        break;
                    default:
                        break;
                }
